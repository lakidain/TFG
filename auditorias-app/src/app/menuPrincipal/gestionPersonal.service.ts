...
export class GestionPersonalService {
  ...
  private urlEndPointEmpleados: string = URL_BACKEND + '/api/empleados';
  private urlEndPointEmpresas: string = URL_BACKEND + '/api/empresasAudited';
  private urlEndPointAuditTypes: string = URL_BACKEND + '/api/auditTypes';
  private urlEndPointAudit: string = URL_BACKEND + "/api/audit";
  private urlEndPointCompanyAuditList: string = URL_BACKEND + "/api/auditCompany";
